...
$route['DigitalAssets/(:any)']  = 'Company/companyFullView';
$route['DigitalAssets/(:any)/(:num)']  = 'Company/companyFullView/$1/$2';
$route['ICOs/(:any)']  = 'Company/companyFullView';
$route['ICOs/(:any)/(:num)']  = 'Company/companyFullView/$1/$2';
$route['event-full-view/(:any)']  = 'Company/eventFullView';
$route['event-full-view/(:any)/(:num)']  = 'Company/eventFullView/$1/$2';
$route['view-profile/(:any)']       = 'User/viewProfile';
$route['view-profile/(:any)/(:num)'] = 'User/viewProfile/$1/$2';  
...
$route['admin/events']              = "admin/Companies/events"; 
...
$route['admin/add-events']           = "admin/Companies/addEvent";
...
$route['admin/edit-event/(:any)']          = "admin/Companies/editEvent/(:any)";
