		...
		<table  border="0" style="border-collapse: collapse; border:1px solid #E4E4E4;" cellpadding="10">
			...
			<tr>
				<td colspan="3">
					...
					<p>Verify your account using this link:</p>
					<p><a style="text-decoration:none;color:#227cec;font-family:Trebuchet MS;font:normal 12px arial;border:1px solid #227cec;padding: 6px 17px 6px 10px;" href="<?php echo $regLink; ?>">Confirm your Email</a></p>
					<p>Or copy and paste the following into your browser:</p>
					<p><a style="text-decoration: none; color:#428bca" href="<?php echo $regLink; ?>"><?php echo $regLink; ?></a></p>
				</td>
			</tr>
			<tr >
				<td colspan="3">
