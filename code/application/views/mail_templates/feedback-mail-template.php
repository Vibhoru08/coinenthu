...
<html>
  <head>
	<title> Coinenthu - Feedback</title>
		...
		<table  border="0" style="border-collapse: collapse; border:1px solid #E4E4E4;" cellpadding="10">
			...
			<tr>
				<td colspan="3">
					...
					<p>Please submit any comments for us below:<?php echo ucfirst($comments);?></p>
					<p>Would you like to speak with us to share your site experience?&nbsp;&nbsp;<?php echo $cname; ?></p>
				</td>
			</tr>
