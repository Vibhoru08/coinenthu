    ...
    <section class = "content">
      ...
      <?php
        ...
        <div class = "row mar_t40">
          ...
          <div class = "row">
          <span>Read about <i>DIGITAL ASSETS</i>,<br>share your experience and help others make the right decision while investing.</span>
          </div>
        ...
        <div class="big_hide">
          <div id="myModal_upcoming" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="new_boxes upcoming_box_padding mar_b5upcoming">
  <!--<div class = "text-center">
    <h4 style="display:inline-block;">UPCOMING EVENTS</h4><span class="close_upcoming"><i class="fa fa-close" ></i></span>
  </div>-->
  <div>
