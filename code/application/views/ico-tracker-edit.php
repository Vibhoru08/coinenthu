		...
		<div class="container-fluid">
			<section class="content-header">
					...
					<ol class="breadcrumb">
					  ...
					  <li class="active">Edit an ICO</li>
					</ol>
			</section>
		</div>
		</div>
					...
					<div class="col-md-12">
						<div class="box mar_b50  mar_t20 box_shadow overflow_hidden">
							<div class="box-header with-border header_bg">
								<h3 class="box-title">Edit an ICO </h3>
							</div>
							...
							<div class="box-body pad_t30">
								<div class="col-md-3 text-center">
									...
									if(isset($digitalData['company_picture']) && $digitalData['company_picture'] != ""){?>
										<img src="<?php echo base_url().'asset/img/companies/icotracker/'.$digitalData['company_picture'].'?id='.$viewTime; ?>" alt="User Image" class="img-responsive" id="image" name="image" style="width:auto;height:200px;">
									<?php }else{ ?>
								...
								<div class="col-md-7">
									...
									<input type="hidden" value="<?php echo $digitalData['company_picture']; ?>" id="userhidImage" name="userhidImage">
									  <div class="form-group">
										...
										data-fv-regexp-regexp="^\d*[a-zA-Z]{1,}\d*" $data-fv-regexp-message="The asset name can consist of alphanumarical characters" data-fv-stringlength="true" data-fv-stringlength-max="100" data-fv-stringlength-message="The asset name must be less than 100 characters" value="<?php echo $digitalData['company_name']; ?>">
										</div>
									  </div>
									  ...
									  <div class="form-group">
										...
										data-fv-regexp-regexp="^\d*[a-zA-Z]{1,}\d*" $data-fv-regexp-message="The description can consist of alphanumarical characters" data-fv-stringlength="true" data-fv-stringlength-max="2000" data-fv-stringlength-message="The description must be less than 2000 characters"><?php echo $digitalData['company_desc']; ?></textarea>
										</div>
									  </div>
									  <?php
									...
									<div class="form-group">
									  ...
									  <div class="form-group">
										...
										<div class="col-sm-9">
										  <input type="text" class="form-control" id="cm_total_token_supply" name="cm_total_token_supply" placeholder="Total Token Supply" value="<?php echo  $digitalData['cm_total_token_supply']; ?>" data-fv-regexp="true"
									  ...
									  <div class="form-group">
										...
										<div class="col-sm-9">
										  <input type="text" class="form-control" id="cm_tokens_available_crowd_sale" name="cm_tokens_available_crowd_sale" placeholder="Tokens Available for ICO" value="<?php echo  $digitalData['cm_tokens_available_crowd_sale']; ?>" data-fv-regexp="true"
											data-fv-regexp-regexp="^\d+(,\d+)*$" data-fv-stringlength="true" data-fv-stringlength-max="20">
										</div>
									  </div>
										  ...
										  <div class="form-group" id="escrow_team_<?php echo $escrw; ?>">
											...
											<div class="col-sm-9">
											 <div class="row">
												...
												<div class="more_input_boxes" id="escrow_btn_<?php echo $escrw; ?>"><a href="javascript:void(0);" OnClick="escrow_details(<?php echo $escrw; ?>);" class="btn btn-primary"><span class="fa fa-minus" aria-hidden="true"></span></a></div>
											</div>
											</div>
										  </div>
										<?php
										  ...
										  <div class="form-group" id="escrow_team_<?php echo $escrw; ?>">
											...
											<div class="col-sm-9">
											 <div class="row">
												...
												<div class="more_input_boxes" id="escrow_btn_<?php echo $escrw; ?>"><a href="javascript:void(0);" OnClick="escrow_details(<?php echo $escrw; ?>);" class="btn btn-primary"><span class="fa fa-plus" aria-hidden="true"></span></a></div>
											</div>
											</div>
										  </div>
										</span>
							...
							<?php
								...
								if(count($digitalData['te_title']) > 0){
									foreach($digitalData['te_title'] as $trex=>$te_title){?>
									  ...
									  <div class="form-group">
										<label for="Inflation" class="col-sm-3 control-label">ICO End Date & Time <span class="mstar">*</span></label>
										<div class="col-sm-9">
											<div class="row">
												<div class="col-md-6">
								...
								<input type="hidden" id="companyhidId" name="companyhidId" value="<?php echo $digitalData['company_id']; ?>">
									  ...
									  <span id="loadUpdateDigital"  style="float:left;display:none">Updating...</span>
										<div class="col-sm-offset-3 col-sm-9">
										   <a href="<?php echo base_url();?>my-ico-trackers" class="btn btn-default">CANCEL</a>
										  <button type="submit" class="btn btn-danger">UPDATE <span class="mm_show">AN </span> <span class="m_hide"></span> ICO </button>
										</div>
									  </div>
								</div>
							</div>
...
<input type="hidden" name="milestonesboxesTotCnt" id="milestonesboxesTotCnt" value="<?php echo count($digitalData['ms_title'])+1; ?>">
...
<script>
	/* $(document).ready(function() {
		$(document).on('change','#ico_uploaded_file',function(){
			var file_data = document.getElementById('ico_uploaded_file').files[0];
			var img_name = file_data.name;
			//var img_ext = img_name.split('.').pop().tolowerCase();
			//alert(img_name);return false;
			var form_data = new FormData();
			form_data.append('ico_uploaded_file', file_data);
			$.ajax({
	...
	$(document).ready(function() {
		...
		onClose: function (selectedDate) {
					...
					$('#update_digital_asset').formValidation('revalidateField', 'cm_ico_start_date');
                },
		dateFormat: 'mm/dd/yy',
		changeMonth: true,
    ...
    $( "#cm_ico_end_date" ).datepicker({
		...
		onClose: function (selectedDate) {
					...
					$('#update_digital_asset').formValidation('revalidateField', 'cm_ico_end_date');
				},
		dateFormat: 'mm/dd/yy',
		changeMonth: true,
		changeYear: true,}).datepicker();
 ...
 function updateCoords(c){
	...
	function mailstone_boxes( cnt )
	{
		...
		var TotMileStonesBoxesCnt = $('#milestonesboxesTotCnt').val();
		...
		if(TotMileStonesBoxesCnt < 20){
			...
			$('#milestonesboxesTotCnt').val(parseInt(TotMileStonesBoxesCnt)+parseInt(1));
			var html = "";
	...
	function deleteTopCompany(cnt,totalDivs,type){
		...
		$("#whitchPage").val(type);
		if(type=='milestone'){
			var typeMode = " Do you want to delete a milestone? ";
		}else if(type=='coreteam'){
			var typeMode = " Do you want to delete a coreteam member? ";
		}else if(type=='treading'){
			var typeMode = " Do you want to delete a trading exchange? ";
		}else if(type=='uploads'){
			var typeMode = " Do you want to delete an upload? ";
		}else if(type=='advisory'){
			var typeMode = " Do you want to delete an advisory member? ";
		}else if(type=='escrow'){
			var typeMode = " Do you want to delete the escrow details? ";
		}else if(type=='resource'){
			var typeMode = " Do you want to delete a resources? ";
		}
