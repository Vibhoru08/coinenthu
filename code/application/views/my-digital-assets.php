	...
	<div class="container-fluid m_margin_0">
	  <section class="content no-margin">
		<div class="row">
			...
			<div class="box mar_b5 sorting home_box_n">
				...
				<div class="row">
					<div class="col-md-4 msearch_bg mpad_b10">
						<input class="form-control brg_focus_n" onkeyup="sreachterm();" type="text" name="searchterms" id="searchterms" placeholder="Search Assets">
					</div>
							...
							<div class="form-group">
								<ul class="nav navbar-nav">
								 <li class="dropdown mpull_right select_dropdown" id="change_u">
								  ...
								  <ul class="dropdown-menu user_dropdown_t" role="menu" style="width:220px">
			...
			<input type="hidden" id="pageMode" value="mylist_digital" />
			...
			<?php } }else{ ?>
			 You have not yet added any companies.
			<?php } ?>
