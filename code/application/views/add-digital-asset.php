									 ...
									 <div class="form-group">
									  ...
									  <span id="core_team_divs">
										  <div class="form-group" id="core_team_1">
											...
											<div class="row pos_r">
												<div class="col-md-6">
												  <input type="text" class="form-control"  placeholder="Name" name="cot_name[]"  id="cot_name_0">
												</div>
												<div class="col-md-6 mmar_t15">
									  ...
									  <div class="form-group text-right">
									   <span id="loadAddDigital"  style="float:left;display:none">Inserting...</span>
										<div class="col-sm-offset-3 col-sm-9">
										  ...
										  <button type="submit" class="btn btn-danger">ADD <span class="mm_show">AN </span> <span class="m_hide">DIGITAL</span> ASSET</button>
										</div>
									  </div>
