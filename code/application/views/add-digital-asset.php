									  ...
									  <span id="milestones_boxes">
										  <div class="form-group" id="milestone_div_1">
											...
											<div class="row no-margin mailstone_pad_bg">
												<div class="col-md-8">
													<textarea class="form-control background_color" placeholder="Milestones" name="ms_title[]"  id="ms_title_0"></textarea>
												</div>
												<div class="col-md-4 mmar_t15 select_style">
													<select class="form-control background_color" name="ms_mss_id[]" id="ms_mss_id_0">
