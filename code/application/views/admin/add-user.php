		 ...
		 <div class="col-md-12">
			<div class="box">
                ...
                <form class="form-horizontal" action="" method="POST" name="add_user" id="add_user" enctype="multipart/form-data"  data-fv-message="This value is not valid"
                      ...
                      data-fv-icon-validating="glyphicon glyphicon-refresh"  onSubmit="addUser();">
				  ...
				  <div class="col-md-7">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-8">
						<input type="text" class="form-control" id="p_u_username" name="p_u_username" placeholder="User Name" required data-fv-notempty-message="The username is required and cannot be empty" data-fv-regexp="true"
					...
					<div class="form-group">
                      <label for="emailaddress" class="col-sm-3 control-label">Email Address <sup>*</sup></label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" id="email_address" name="email_address" placeholder="Email Address" required data-fv-notempty-message="The email is required and cannot be empty" 
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-8">
						...
						data-fv-identical-field="u_password" 
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" id="u_mobile" name="u_mobile" value="" placeholder="Mobile Number">
						</div>
                    </div>
					</div>
                  </div>
