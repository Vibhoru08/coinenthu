<div class="content-wrapper">
	<section class="content-header">
		<h1> Top ICO Trackers </h1>
		<ol class="breadcrumb">
			<li class="" style="margin-top:-10px;"><a href="<?php echo $baseUrl; ?>ico-trackers" class="btn btn-info pull-right" style="color:#fff;"><i class="glyphicon glyphicon-arrow-left"></i> Back</a></li>
		</ol>
	</section>
						...
						<div class="box-body mandatory_color">
							<div class="col-md-12">
								...
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-2 control-label" > ICOs <sup>*</sup></label>
									...
									<button type="button" class="btn btn-info" style="margin-right:10px;" onclick="setTopCompanies(2)">Save</button>
