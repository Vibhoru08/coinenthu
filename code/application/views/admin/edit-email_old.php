			...
			<div class="box">
                ...
                <form class="form-horizontal" action="" method="POST" name="edit_email" id="edit_email" enctype="multipart/form-data" data-fv-message="This value is not valid"
				  ...
				  <div class="col-md-7"> 
					...
					<?php 
					/*	if(isset($subscriberdeatils->bop_sub_name) && $subscriberdeatils->bop_sub_name!=""){
										$bop_sub_name = $subscriberdeatils->bop_sub_name;
						}else{
										$bop_sub_name = '';
						} */
					?>	
                      <label for="email" class="col-sm-3 control-label">Name <sup>*</sup></label>
                      <div class="col-sm-8">
						<input type="text" class="form-control" id="name" name="name" placeholder="Name" required data-fv-notempty-message="The name is required and cannot be empty" value="<?php echo $bop_sub_name;?>">				  
						<p id="name_error" name="name_error"></p>
                      </div>
                    </div>                   -->
							<div class="form-group">
								<?php 
