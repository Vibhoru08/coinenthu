    ...
    <div class="no_background mar_b0  mar_t0 no_shadow overflow_hidden">
      ...
      <div class="box-body pad_t30">
        <div class="col-md-3 text-center">
          ...
          <input name="event_uploaded_file" id="digital_uploaded_file" type="file" onchange="readURL(this);" accept="image/x-png,image/jpeg" /><br/>
          </div>
        </div>
        <div class="col-md-7">
          ...
          <div class="col-md-6">
            ...
            <input type="hidden" id="core_team_cnt" value="1" />
             ...
             <div class="col-sm-9">
               <div class="row">
                 <div class="col-md-6">
                  <input type="text" class="form-control" id="cm_ico_start_date" name="ev_sd" value = "<?php echo date('m/d/Y',strtotime($event_sd)); ?>" class="form-control" placeholder="Event Start Date " readonly style="background-color:#fff;" required data-fv-notempty-message="The start date is required" >
                 </div>
             ...
             <div class="col-sm-9">
               <div class="row">
                 <div class="col-md-6">
                  <input type="text" id="cm_ico_end_date" name="ev_ed" value = "<?php echo date('m/d/Y',strtotime($event_ed)); ?>" class="form-control" placeholder="Event End Date "  readonly style="background-color:#fff;" required data-fv-notempty-message="The end date is required">
                 </div>
                 <div class="col-md-6 mmar_t15">
