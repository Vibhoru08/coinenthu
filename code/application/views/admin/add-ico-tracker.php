	...
	// echo '<pre>';print_r($milestoneStatuses);exit;
	?>
        ...
        <!-- Content Header (Page header) -->
		 ...
		 <div class="col-md-12">
			<div class="box controls">
                ...
                <form class="form-horizontal" action="" method="POST" name="add_ico_tracker" id="add_ico_tracker" enctype="multipart/form-data"  data-fv-message="This value is not valid"
                      data-fv-icon-valid="glyphicon"
                      data-fv-icon-invalid="glyphicon"
                      data-fv-icon-validating="glyphicon glyphicon-refresh"  onSubmit="addIcoTracker();">
				  ...
				  <div class="col-md-7">
                    ...
                    <div class="form-group" >
                      ...
                      <div class="col-sm-8">
						...
						data-fv-regexp-regexp="^\d*[a-zA-Z]{1,}\d*" $data-fv-regexp-message="The company name can consist of alphanumarical characters" data-fv-stringlength="true" data-fv-stringlength-max="2000" data-fv-stringlength-message="The company name must be less than 2000 characters">
					  </div>
				  ...
				  <div class="form-group" id="resource_1">
					...
					<div class="more_input_boxes col-md-1" id="resource_btn_1"><a href="javascript:void('0');" onClick="resources(1);" class="btn btn-success"><span class="fa fa-plus" aria-hidden="true"></span></a></div>
				</div>
				  </span>
					<div class="form-group">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-8">
                       <input type="text" id="cm_total_token_supply" name="cm_total_token_supply" class="form-control" placeholder="Total Token Supply" data-fv-regexp="true"
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-8">
                       <input type="text" id="cm_tokens_available_crowd_sale" name="cm_tokens_available_crowd_sale" class="form-control" placeholder="Tokens Available for Crowd Sale" data-fv-regexp="true"
										data-fv-regexp-regexp="^\d+(,\d+)*$" data-fv-stringlength="true" data-fv-stringlength-max="20">
					  </div>
                    </div>
					<div id="noaSpanRegFileDivs">
					...
					<span id="escrow_divs">
					<div class="form-group" id="escrow_team_1">
					...
					<div class="more_input_boxes col-md-1" id="escrow_btn_1"><a href="javascript:void(0);" OnClick="escrow_details(1);" class="btn btn-success"><span class="fa fa-plus" aria-hidden="true"></span></a></div>
					</div>
					</span>
				  ...
				  <span id="treading_exchange_divs">
					...
					<div class="">
						<div class="">
							<div class="col-md-4">
							 <input type="text" class="form-control" id="cm_ico_start_date" name="cm_ico_start_date" class="form-control" placeholder="ICO Start Date " onChange="icoDateChnge(1);" readonly style="background-color:#fff;" required data-fv-notempty-message="The start date is required">
							</div>
							<div class="col-md-4 mmar_t15">
				  ...
				  <div class="form-group">
					...
					<div class="">
						<div class="">
							<div class="col-md-4">
							 <input type="text" id="cm_ico_end_date" name="cm_ico_end_date" class="form-control" placeholder="ICO End Date " onChange="icoDateChnge(2);" readonly style="background-color:#fff;" required data-fv-notempty-message="The end date is required">
							</div>
							<div class="col-md-4 mmar_t15">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" id="cm_email" name="cm_email" placeholder="Email ID" data-fv-emailaddress="true"
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" id="cm_telegram" name="cm_telegram" value="" placeholder="Telegram" data-fv-stringlength="true" data-fv-stringlength-max="100" data-fv-stringlength-message="The telegram url must be less than 100 characters" >
						</div>
                    </div>
					<div class="form-group">
                      <label for="inputEmail3" class="col-sm-3 control-label">Github</label>
					<div class="col-sm-8">
						<input type="text" class="form-control" id="cm_github" name="cm_github" value="" placeholder="Github" data-fv-stringlength="true" data-fv-stringlength-max="100" data-fv-stringlength-message="The github url must be less than 100 characters" >
					</div>
                    </div>
					<div class="form-group">
                      <label for="inputEmail3" class="col-sm-3 control-label">Discord</label>
					<div class="col-sm-8">
						<input type="text" class="form-control" id="cm_discord" name="cm_discord" value="" placeholder="Discord" data-fv-stringlength="true" data-fv-stringlength-max="100" data-fv-stringlength-message="The Discord url must be less than 100 characters" >
					</div>
                    </div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" id="cm_facebook" name="cm_facebook" value="" placeholder="Facebook" data-fv-stringlength="true" data-fv-stringlength-max="100" data-fv-stringlength-message="The facebook url must be less than 100 characters" >
						</div>
                    </div>
					 <div class="form-group">
                  ...
                  <div class="box-footer">
					<span id="loadIcoTracker"  style="float:left;display:none"><i class="fa fa-refresh fa-spin"></i></span>
					<span id="successMsg"></span>
                    <button type="submit" class="btn btn-info pull-right">Add </button>
					<a href="<?php echo base_url();?>admin/ico-trackers"><button type="button" class="btn btn-default pull-right" style="margin-right:10px;">Cancel</button></a>
                  </div>
                </form>
				<!-- Form End -->
            </div>
...
<script>
	$(document).ready(function() {
		$('#add_ico_tracker').formValidation();
...
function noaAdvisoryAddIFile( existingFNo )
{
	...
	//total advisory boxes available
...
function noaTrExAddIFile( existingFNo )
{
	...
	//tottal boxes of trade exchanges
