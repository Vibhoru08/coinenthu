<?php
//print_r($digitalData);exit;
// echo '<pre>';print_r($digitalData);exit;
        ...
        <!-- Content Header (Page header) -->
		 ...
		 <div class="col-md-12">
			<div class="box controls">
                ...
                <form class="form-horizontal" action="" method="POST" name="update_digital_asset" id="update_digital_asset" enctype="multipart/form-data"  data-fv-message="This value is not valid"
                      data-fv-icon-valid="glyphicon"
                      data-fv-icon-invalid="glyphicon"
                      data-fv-icon-validating="glyphicon glyphicon-refresh" onSubmit="UpdateDigitalAsset();">
                  <div class="box-body mandatory_color">
				  <div class="col-md-2">
					<div class="text-center">
						<?php
						if(isset($digitalData['company_picture']) && $digitalData['company_picture'] != ""){?>
							<img src="<?php echo base_url().'asset/img/companies/digitalasset/'.$digitalData['company_picture'].'?id='.$viewTime; ?>" alt="User Image" class="img-thumbnail" id="image" name="image" style="width:160px;height:160px;">
						<?php
						}else{?>
				  ...
				  <div class="col-md-7">
				    ...
				    <div class="form-group" >
                      ...
                      <div class="col-sm-8">
						...
						data-fv-regexp-regexp="^\d*[a-zA-Z]{1,}\d*" $data-fv-regexp-message="The asset name can consist of alphanumarical characters" data-fv-stringlength="true" data-fv-stringlength-max="2000" data-fv-stringlength-message="The asset name must be less than 2000 characters" value="<?php echo $digitalData['company_name']; ?>">
                  ...
                  <div class="box-footer">
					<span id="loadUpdateDigital"  style="float:left;display:none"><i class="fa fa-refresh fa-spin"></i></span>
...
function noaRegnAddIFile( existingFNo )
{
	...
	if(TotCoreTeamBoxesCnt < 20){
		...
		noaNewRegFileDivHtml = '<div class="voca form-group" id="noaDivRegFile_'+noaNewRegFileId+'">';
			...
			noaNewRegFileDivHtml +='<input class="form-control" placeholder="Linkedin URL" name="cot_profile_url[]" id="cot_profile_url_'+noaNewRegFileId+'" type="text" value="" data-fv-stringlength="true" data-fv-stringlength-max="100" data-fv-stringlength-message="The Linkedin URL must be less than 100 characters" ></div>';
...
function noaAdvisoryAddIFile( existingFNo )
{
	...
	if(TotadvisoryBoxesCnt < 20){
		...
		noaNewRegFileDivHtml = '<div class="voca form-group" id="noaDivAdvisoryFile_'+noaNewRegFileId+'">';
			...
			noaNewRegFileDivHtml +='</div><div class="col-md-4">';
			noaNewRegFileDivHtml +='<input class="form-control" placeholder="Linkedin URL" name="adt_profile_url[]" id="adt_profile_url_'+noaNewRegFileId+'" type="text" value="" data-fv-stringlength="true" data-fv-stringlength-max="100" data-fv-stringlength-message="The Linkedin URL must be less than 100 characters" ></div>';
